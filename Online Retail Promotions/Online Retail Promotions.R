...
library(readxl)
d <- read_excel("C:/Users/simra/Downloads/OnlineRetailPromotions (1).xlsx", sheet="Data")
str(d)                                    # 64,000 obs
...
dconvert <- subset(dvisit, conversion==1)     # People who made a purchase
